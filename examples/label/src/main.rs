use std::env;
use embedded_graphics::{geometry::{Point, Size}, mono_font::{MonoTextStyle, ascii::FONT_6X10}, pixelcolor::BinaryColor, primitives::{Primitive, PrimitiveStyleBuilder, Rectangle}};
